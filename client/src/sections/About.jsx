      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <motion.h2
            ...
            className="text-3xl md:text-3xl lg:text-4xl font-serif font-light text-v-ivory leading-[1.1] mb-8"
          >
            Built for those who value timeless living. <br className="hidden md:inline" />
            <span className="gold-gradient-text italic font-medium">Designed with intent, made for living</span>
          </motion.h2>
          ...
          >
            <p className="text-lg md:text-xl font-serif italic text-v-beige/90 leading-relaxed font-light">
              "We build homes, not houses. The difference is in everything you don't notice at first—how a space holds your family instead of just containing it."
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-v-beige/70 leading-relaxed font-light max-w-2xl mt-4"
          >
            <div className="space-y-2">
              <h4 className="text-xs font-serif tracking-luxury text-v-gold uppercase">The Meaning of Vedra</h4>
              <p className="text-[11px] text-v-gold/50 uppercase tracking-wider">Ved — Knowledge . Dra — Roots</p>
              <p>
                Vedra is the quiet wisdom of where a home begins and how it should live. We slow down to listen and understand how you live, choosing materials to last, not to impress.
              </p>
            </div>
            <div className="space-y-2">
              <h4 className="text-xs font-serif tracking-luxury text-v-gold uppercase">Bespoke Creation</h4>
              <p className="text-[11px] text-v-gold/50 uppercase tracking-wider">Built to Last, End to End</p>
              <p>
                We care for the things you'll never see—the structural integrity, the details behind the walls—as much as the ones you will, creating homes that feel effortless to live in.
              </p>
            </div>
          </motion.div>
